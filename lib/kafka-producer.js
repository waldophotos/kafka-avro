 ...
 */
Producer.prototype.Producer = function (opts) {
 ...
 */
Producer.prototype._produceWrapper = function (producerInstance, topic,
  partition, value, key) {

  if (!this.valueSchemas[topic]) {
    // topic not found in schemas, bail early
    return producerInstance.__kafkaAvro_produce(topic, partition, value, key);
  }
