...
Producer.prototype.getProducer = Promise.method(function (opts) {
  ...
  console.log('KafkaAvro.Producer.getProducer() :: Starting producer with',
    'options:', opts);
...
Producer.prototype._produceWrapper = function (producerInstance, kafkaTopic,
  ...
  if (!this.valueSchemas[topicName]) {
    ...
    console.warn('KafkaAvro.Producer._produceWrapper() :: Warning, did not find',
      'topic on SR:', topicName);
